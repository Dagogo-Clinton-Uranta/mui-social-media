  ...
  return (
    <Box sx={{display:{xs:"none",sm:"block"}}} flex={2} p={2}>
      <Box postion="fixed" width={300}>
       ...
       <Avatar alt="Agnes Walker" src="https://material-ui.com/static/images/avatar/10.jpg" />
       <Avatar alt="Trevor Henderson" src="https://material-ui.com/static/images/avatar/11.jpg" />
       <Avatar alt="Agnes Walker" src="https://material-ui.com/static/images/avatar/12.jpg" />
       <Avatar alt="Trevor Henderson" src="https://material-ui.com/static/images/avatar/13.jpg" />
     </AvatarGroup>
